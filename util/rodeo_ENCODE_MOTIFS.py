...
df["Motifs_peak"] = df["Motifs_count"] / df["one"]
...
group_counts_sum["Motifs/Peaks"] = group_counts_sum["Motifs_count"] / group_counts_sum["one"]

#Barplot
t = sns.barplot(x="Subcompartment", y = "Motifs/Peaks", data=group_counts_sum, palette=pink)
t.set(xlabel="Sub-compartment")
t.set(ylabel="TF Motifs/Peaks")
t.set(title="TF Motifs/Peaks by Sub-compartment")

#boxplot
b = sns.rugplot(df["Motifs_peak"])
b.set(xscale="log")
#Countplot
