...
# NEED TO CUSTOMIZE
inDir='/data/miraldiLab/LCL_repo/reference_datasets/accesome/ENCODE_DNASE_GM12878_FASTQ/ENCFF000SLR'
outDir='/data/miraldiLab/LCL_repo/20180724_ENCODE_DNASE_MASKED_HG19/output/ENCFF000SLR'

# NEED TO CUSTOMIZE
sample='ENCFF000SLR'
sampleName='ENCFF000SLR'
...
# 10/12/17  from Roberto:
      ...
      BowtieIndex='/data/miraldiLab/LCL_repo/reference_datasets/genome/hg19_masked/hg19_masked'
