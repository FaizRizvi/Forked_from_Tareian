...
# NEED TO CUSTOMIZE
inDir='/data/miraldiLab/LCL_repo/reference_datasets/accesome/ENCODE_DNASE_GM12878_FASTQ/ENCFF000SLL'
outDir='/data/miraldiLab/LCL_repo/20180724_ENCODE_DNASE_MASKED_HG19/output/ENCFF000SLL'

# NEED TO CUSTOMIZE
sample='ENCFF000SLL'
sampleName='ENCFF000SLL'
