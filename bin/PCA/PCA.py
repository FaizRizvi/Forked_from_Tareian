...
sn.regplot(x="x", y="y", data=plot, fit_reg=False)
#plt.ylim(10, -10)
#plt.xlim(-35, 35)
...
"""Trial Method"""
#To use SKlearn you need to transpose the dataset so that the columns are the genes and the rows are the samples
...
df['Lineage'] = df['Name'].map(meta.set_index('Name')['Lineage'])
